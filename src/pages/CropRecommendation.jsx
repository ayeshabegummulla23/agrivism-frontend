...
const soilConditions = [
  { icon: <FiSun />, label: 'Temperature', value: '28°C', status: 'Optimal' },
  { icon: <FiDroplet />, label: 'Soil Moisture', value: '55%', status: 'Good' },
  { icon: <FiWind />, label: 'Humidity', value: '65%', status: 'Moderate' },
]
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <DashboardHeader title="Crop Recommendation" />
        <main className="flex-1 p-6 overflow-y-auto">
          <div className="max-w-4xl mx-auto space-y-6">
            {/* Current Conditions */}
            <div className="bg-gradient-to-r from-primary to-emerald-500 rounded-2xl p-6 text-white">
              <h3 className="text-lg font-bold mb-4">Current Farm Conditions</h3>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-400 mt-2">Season: {crop.season}</p>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
              <h3 className="font-semibold text-gray-900 mb-4">Recommendation Factors</h3>
              <div className="grid sm:grid-cols-2 gap-3">
                {['Soil Type (Red Soil)', 'Water Source (Borewell)', 'Weather Conditions', 'Market Demand', 'Growth Period', 'Investment Required'].map((f) => (
